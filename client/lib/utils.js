...
Template.registerHelper('trust', function() {
...
Template.registerHelper('maxTrust', function() {
  return maxTrust.get()
})

var ss = {
  'es': 'Spanish',
  'es-p': 'Spanish-proposal', 
  'en': 'English', 
  'la': 'Latin', 
  'jp': 'Japanese', 
  'ro': 'Romanian', 
  'ro-p': 'Romanian-proposal', 
  't': 'Official Ids'
}
Template.registerHelper('country', function(sy) {
  return ss[sy]
})
